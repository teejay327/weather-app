       ...
       <ul>
        <li>
          <div className='sevendayforecast__img'>
            ...
            <div className='sevendayforecast__date' >Tuesday 13 June</div>
        ...
        <li>
          ...
          <svg width="80px" height="60px" viewBox="0 0 60 60">
            ...
            <div className='sevendayforecast__date' >Wednesday 14 June</div>
        ...
        <li>
          ...
          <svg width="80px" height="60px" viewBox="0 0 60 60">
            ...
            <div className='sevendayforecast__date' >Thursday 15 June</div>
            <div className='sevendayforecast__mintemp' >20&#8451;</div>
        ...
        <li>
          ...
          <svg width="80px" height="60px" viewBox="0 0 60 60">
            ...
            <div className='sevendayforecast__date' >Friday 16 June</div>
            <div className='sevendayforecast__mintemp' >19&#8451;</div>
        ...
        <li>
          ...
          <div className='sevendayforecast__date' >Saturday 17 June</div>
        ...
        <li>
          ...
          <div className='sevendayforecast__date' >Sunday 18 June</div>
            <div className='sevendayforecast__mintemp' >19&#8451;</div>
        ...
        <li>
          ...
          <svg width="80px" height="60px" viewBox="0 0 60 60">
            ...
            <div className='sevendayforecast__date' >Monday 19 June</div>
            <div className='sevendayforecast__mintemp' >21&#8451;</div>
            <div className='sevendayforecast__maxtemp' >27&#8451;</div>
            <div className='sevendayforecast__rainchance' >5%</div>
            <div className='sevendayforecast__rainamount' >1mm</div>
